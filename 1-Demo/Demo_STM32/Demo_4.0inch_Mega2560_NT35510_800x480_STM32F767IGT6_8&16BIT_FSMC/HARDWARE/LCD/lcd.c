...
void LCD_GPIOInit(void)
{
		...
		GPIO_Initure.Pin=GPIO_PIN_8;            //PB8,复位
  ...
  SRAM_Handler.Init.MemoryDataWidth=FMC_NORSRAM_MEM_BUS_WIDTH_16; //16位数据宽度
		...
		FSMC_WriteTim.DataSetupTime=0x25;           	//数据保存时间(DATAST)为4.6ns*15个HCLK=69ns
...
void LCD_FSMC_Write_Time_Set(uint32_t AST, uint32_t DST)
{
